...
<body>
    <div>
        <div class="user-pic col-xl-12 col-lg-12 col-md-4 col-sm-4 text-center">
            <img class="img-fluid img-rounded" id="img-logo" src="../resources/img/logo.png" alt="User picture">
        </div>
